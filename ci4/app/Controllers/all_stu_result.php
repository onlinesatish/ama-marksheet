...
//   function remarks($m){
// 		 if ($m>90) {
// 			return "Result is excellent. Keep it up.";
// 		} else if ($m>80) {
// 			return "Result is best but need keep it up.";
// 		} else if ($m>70) {
// 			return "Result is better Need improve & keep it up.";
// 		} else if ($m>60) {
// 			return "Result is good but not fair. Increase hard work.";
// 		} else if ($m>50) {
// 			return "Result is average! Increase hard work.";
// 		} else if ($m>40) {
// 			return "Result is below to average. Do hard work to improve it.";
// 		} else if ($m>30) {
// 			return "Result is poor. Need much hard work to improve it.";
// 		} else{
// 			return "Result is very poor. Need very much hard work to improve it.";
// 		}
// 	}
      ...
      * {
      ...
      .marksheet {
        ...
        background: linear-gradient(
          ...
          url("https://v1.anshumemorial.in/assets/static/img/ama/ama-128x128.png")
            center/60px 60px round;
...
?>
    ...
    <!-- marksheet main div -->
   <table class="pt-3"><tr><td>&nbsp;</td></tr></table>
                ...
                <tr>
                  ...
                  <td style="width: 70%">
                    <table style="width: 100%">
                        ...
                        <td>
                          <p class="h6 text-center">
                            <a
                              ...
                              target="_blank"
                              >Bhatha Chowk, Bhatha Dasi, Rajapakar, Vaishali</a
                            >
                          </p>
                        </td>
                      </tr>
                      ...
                      <tr>
                        <td>
                          <p class="h6 text-center">Run & Managed by SICT</p>
                        </td>
                      </tr>
                    </table>
                  </td>
                  ...
                  <td style="width: 15%">
                    <img
                      ...
                      width="75px"
                      height="75px"
                      src="https://v1.anshumemorial.in/assets/static/img/bbbp512.png"
                      alt=""
                      srcset=""
                    />
                  </td>
          ...
          <tr>
            <td>
              <table class="mx-auto" style="width: 100%">
                ...
                <tr>
                  <td>
                    <h6 class="text-center">ACADEMIC SESSION : 2020-21</h6>
                  </td>
                </tr>
              </table>
            </td>
                ...
                <tr>
                  ...
                  <td class="" style="width: 75%">
                    <table class="table" style="width: 100%">
                      <tr>
                        <th>Name</th>
                        <td><strong>:</strong></td>
                        <td><?=ucwords($r['stu_name']);?></td>
                      </tr>
                      <tr>
                        <th>Father's Name</th>
                        <td><strong>:</strong></td>
                       <td><?=ucwords($r['father_name']);?></td>
                      </tr>
                      <tr>
                        <th>Mother's Name</th>
                        <td><strong>:</strong></td>
                       <td><?=ucwords($r['mother_name']);?></td>
                      </tr>
                  ...
                  <td style="width: 20%">
                    <table style="width: 100%" class="table">
                      ...
                      <tr class="bg-<?=res($r["total"]/4)["c"];?>">
                        <th colspan="3" class="text-center" >Result</th>
                      </tr>
                      <tr class="bg-<?=res($r["total"]/4)["c"];?>">
                        <th>Grade</th>
                        <td><strong>:</strong></td>
                        <td class="fw-bold"><?=res($r["total"]/4)["g"] ?></td>
                      </tr>
                    </table>
                  </td>
                  <!-- // student school details -->
            ...
            <td>
              <table class="table table-striped mx-auto marks" style="width: 80%">
                ...
                <tr>
                  ...
                  <td>100</td>
                  <td><?=$r['drawing'];?></td>
                  <td><?=res($r['drawing'])["g"];?></td>
                </tr>
                <tr>
                  <th scope="row">Total</th>
                  <th class="text-center">400</th>
                  <th class="text-center"><?=$r['total'];?></th>
                  <th class="text-center"><?=res($r['total']/4)["g"];?></th>
                </tr>
               
              </table>
             <p class="px-5"><strong>Marks in word : </strong><?=ucwords(numberTowords($r['total']));?></p>
              <div class="d-flex justify-content-center"><p style="font-size: 11px;" class="bg-light border-bottom d-inline-block border-secondary"><strong>Grading Scale :</strong> A+(91%-100%), A(81%-90%), B+(71%-80%), B(61%-70%), C+(51%-60%), C(41%-50%), D(31%-40%), E(30% & Below)</p></div>
            </td>
          </tr>
          <!-- draw-line -->
          <!-- <tr>
         ...
         <!-- draw-line -->
          ...
          <tr>
            <td>
              <table class="mx-auto" style="width: 100%">
                <tr>
                  <td class="px-5"><strong>Remarks :</strong> <?=res($r["total"]/4)["r"];?></td>
                </tr>
              </table>
            </td>
          </tr>
                ...
                <tr>
                  <td class="bg-success text-light vw-100">
                    <div class="d-flex justify-content-around">
                      ...
                      <a
                        class="text-light"
                        href="mailto:anshumemorial@gmail.com"
                        >anshumemorial@gmail.com</a
                      >

                      <a
                        class="text-light"
                        href="http://anshumemorial.in"
                        target="_blank"
                        >www.anshumemorial.in</a
                      >
                    </div>
                  </td>
                </tr>
    ...
    <p class="text-center text-muted">
      ...
      <a href="http://twitter.com/AnshuMemoria" target="_blank"
        >Anshu Memorial Academy</a
      >
      (IT Team).
    </p>
