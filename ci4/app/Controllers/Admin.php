...
class Admin extends BaseController
{
    ...
    {
        // this is not right way to set login so  it will removed and use filter funtion 
        if ($this->session->verified_admin) {
            if ($this->request->getMethod() == "get") {
                // show student add page
                return view('admin/gen/add_student',["verified_admin"=>true]);
            } else {
    ...
    // show all students result funcion ----------------------------------------------------------------------------------------------
    ...
    // show all student list function --------------------------------------------------------------------
    ...
    // all deleted student(s) list here ----------------------------------------------------------------------------------------------------
    ...
    // (Temporary delete) send student data into recycle bin ------------------------------------------------------------------------------------------------
    ...
    public function verify_admin()
    {
        if ($this->request->getMethod() == "get") {
            ...
            if ($pw == "S@tish555@sk") {
                $this->session->set("verified_admin", true);
                return redirect()->to(site_url("admin/all_stu"));
            } else {
